                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  <thead className="bg-gray-50 dark:bg-gray-800">
                    ...
                    Category
                      ...
                      <th scope="col" className="px-4 py-3.5 font-bold text-left rtl:text-right text-gray-500 dark:text-gray-400">
                       ...Drop Down
                      </th>
                    ...
                    <div className="inline-flex items-center gap-x-3">
                      ...
                      <div className="flex items-center gap-x-2">
                        ...
                        <h2 className="font-normal text-gray-800 dark:text-white ">Tech requirements.pdf</h2>
                          <p className="text-xs font-normal text-gray-500 dark:text-gray-400"></p>
                        </div>
                      </div>
                    </div>
                  </td>
